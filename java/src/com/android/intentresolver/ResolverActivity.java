...
public class ResolverActivity extends Hilt_ResolverActivity implements
        ...
        return new ResolverMultiProfilePagerAdapter(
                ...
                ImmutableList.of(
                        new TabConfig<>(
                                ...
                                TAB_TAG_PERSONAL + mProfiles.getPersonalHandle().getIdentifier(),
                                personalAdapter)),
                createEmptyStateProvider(/* workProfileUserHandle= */ null),
                /* workProfileQuietModeChecker= */ (userHandle) -> false,
                /* defaultProfile= */ mProfiles.getPersonalProfile(),
    ...
    private ResolverMultiProfilePagerAdapter createResolverMultiProfilePagerAdapterForProfiles(
        ...
        if (mProfiles.getPersonalHandle().equals(intentUser)) {
            ...
            defaultProfile = mProfiles.getWorkProfiles().stream()
                    .filter(profile -> profile.getPrimary().getHandle().equals(intentUser))
                    .findFirst()
                    .orElseGet(() -> mProfiles.getPersonalProfile());
        } else {
            Log.w(TAG, "Falling back to personal profile as selected tab for " +
                    intentUser);
            defaultProfile = mProfiles.getPersonalProfile();
        }
        ...
        return new ResolverMultiProfilePagerAdapter(
                ...
                new ImmutableList.Builder<TabConfig<ResolverListAdapter>>().add(
                        new TabConfig<>(
                                ...
                                TAB_TAG_WORK + workAdapter.getUserHandle().getIdentifier(),
