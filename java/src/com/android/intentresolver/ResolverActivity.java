...
public class ResolverActivity extends FragmentActivity implements
    ...
    public void onHandlePackagesChanged(ResolverListAdapter listAdapter) {
        ...
        if (listAdapter == mMultiProfilePagerAdapter.getActiveListAdapter()) {
            if (getWorkProfileUserHandles().contains(listUser)
    ...
    protected ResolverListAdapter createResolverListAdapter(
        ...
        UserHandle initialIntentsUserSpace = isLaunchedAsCloneProfile()
                ...
                ? getUserHandleSharesheetLaunchedAs() : userHandle;
    ...
    private ResolverMultiProfilePagerAdapter createResolverMultiProfilePagerAdapterForProfiles(
        ...
        if (!getTabOwnerUserHandleForLaunch().equals(intentUser)) {
            ...
            } else if (getWorkProfileUserHandles().contains(intentUser)) {
        ...
        final Intent[] initialIntentsForWork = selectedProfile != PROFILE_PERSONAL
                ? initialIntents : null;
        List<ResolverListAdapter> workAdapters = getWorkProfileUserHandles().stream()
                .map(workProfileUserHandle -> createResolverListAdapter(
                        /* context */ this,
                        /* payloadIntents */ mIntents,
        ...
        return new ResolverMultiProfilePagerAdapter(
                ...
                personalAdapter,
                workAdapters,
                createEmptyStateProvider(getWorkProfileUserHandles()),
    ...
    protected ImmutableList<UserHandle> getWorkProfileUserHandles() {
        return getAnnotatedUserHandles().workProfileUserHandles;
    }

    // TODO: have tests override `getAnnotatedUserHandles()`, and make this method `final`.
    protected ImmutableList<UserHandle> getCloneProfileUserHandles() {
        return getAnnotatedUserHandles().cloneProfileUserHandles;
    }
    ...
    private boolean hasWorkProfile() {
        return !getWorkProfileUserHandles().isEmpty();
    }

    private boolean hasCloneProfile() {
        return !getCloneProfileUserHandles().isEmpty();
    }

    protected final boolean isLaunchedAsCloneProfile() {
        return hasCloneProfile()
                && getCloneProfileUserHandles().contains(getUserHandleSharesheetLaunchedAs());
    }
    ...
    private void createAndRegisterWorkPackageMonitors() {
        mWorkPackageMonitors.clear();
        for (UserHandle workProfileUser : getWorkProfileUserHandles()) {
    ...
    protected final void onRestart() {
        ...
        if (shouldShowTabs()) {
            for (UserHandle workProfileUserHandle : getWorkProfileUserHandles()) {
    ...
    protected List<UserHandle> getResolverRankerServiceUserHandleListInternal(
        ...
        if (userHandle.equals(getPersonalProfileUserHandle())) {
            userList.addAll(getCloneProfileUserHandles());
        }
        return userList;
    }
}
